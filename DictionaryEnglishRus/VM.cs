...
namespace DictionaryEnglishRus
{
    public class VM : BindableBase
    {
        ...
        public VM()
        {
            var tupleTreeAndTime = new DictionaryWords("../../Words.txt").CreateTree();
    ...
    public class DictionaryWords
    {
        ...
        public Tuple<Trie<string>, long, int> CreateTree()
        {
            ...
            using (var streamReader = new StreamReader(PathToWords, Encoding.Default))
            {
                ...
                stopwatch.Stop();
                return Tuple.Create(tree, stopwatch.ElapsedMilliseconds,countWords);
            }
        }
    }
}